...
//@query
$sql = "select students.*,DATE_FORMAT(Students.dob,'%d-%m-%Y') AS dob,courses.course_name from students,courses where courses.course_id=students.course_id and email='$u';"; 
...
<head>
  ...
  <!-- page information-->
  <title>IELTS BUDDY | Student Dashboard</title>
                ...
                <div class="flip-card" >
                  <div class="card__face card__face--front" style="border-radius: 10px;">
                     ...
                     <?php
                      ...
                      {
                         echo "<img src='../assets/profiles/student-profile-male.jpg' class='profile_img my-4' style='width:130px;height:130px;border-radius:49%;' alt='Student profile'>";
                      }
                      else
                      {

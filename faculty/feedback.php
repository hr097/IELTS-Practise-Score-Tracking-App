...
<head>
    ...
    <!-- page information-->
    <title>IELTD BUDDY | Feedback</title>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">IELTS BUDDY | Feedback</h4>
                            <form class="forms-sample" method="post" action="">
                                ...
                                <button type="button" id="submitfeedback" class="btn btn-dark mr-2 mt-3">Submit</button>

    ...
    <div class="container-scroller" style="background-color: #F5F7FF;">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center">
                ...
                <a class="navbar-brand brand-logo mr-3" href="./dashboard.php"><img src="../assets/logos/logo-mini.jpg"
                        alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="./dashboard.php"><img src="../assets/logos/header_logo.png"
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <p class="ac_type" style="margin-right:10px;"><?php echo $_SESSION['_fname']; ?></p>
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <?php
                                ...
                                {
                                    echo "<img src='../assets/profiles/faculty-profile-female.jpg' alt='profile-img' />";
                                }   
                            ?>
                        </a>

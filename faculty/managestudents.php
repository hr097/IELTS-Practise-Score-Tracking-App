...
<head>
        ...
        <!-- Page info -->
        <title>IELTS BUDDY | Manage Students</title>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="editclassroom.php" method="post">
                    ...
                    <div class="separator">OR</div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12" style="margin:auto;">
                          <button type="button"  name="_fetchall" id="fetchall" class="btn btn-dark">Fetch All</button>
                        </div>
                      </div>
                      <!--Semester -->
                    ...
                    <button type="button" id="addstudents"class="btn btn-dark mr-2 mt-3">Add Students</button>

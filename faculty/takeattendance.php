...
{
    $reader = "<div class='row'><div class='col-md-6'><div class='form-group'><label>Select Classroom</label><select name='reader_selection' id='reader_selection' class='form-control'><option value='0'>Not Selected</option>";
...
<head>
        ...
        <!-- Page info -->
        <title>IELTS BUDDY | Take Attendance</title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <button type='button' onclick="window.history.back()"
                             ...
                             class='btn form-control btn-dark btn-icon-text ml-3 mb-4'>
                                    ...
                                    <form class="forms-sample" action="takeattendance.php" method="post">
                                        ...
                                        <div class="row" style="margin-top:-30px;">
                                            <div class="col-md-6">
                                                ...
                                                <button type="button" class="btn btn-dark mr-2 mt-3" id="TakeattButton">Fetch Attendance</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button type="button" id="submitattendance"class="btn btn-dark mr-2 mt-3">Submit Attendance</button>
                                </div>
                            </div>
                        </div>
                    </div>            

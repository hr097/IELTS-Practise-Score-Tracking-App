...
{   
    $sql= "select faculties.*,DATE_FORMAT(vw_faculties.dob,'%d-%m-%Y')AS dob from faculties where fid like '$fid%' and fid NOT IN(select fid from ams_setup_faculties_map where ams_setup_id=$classroomid);";

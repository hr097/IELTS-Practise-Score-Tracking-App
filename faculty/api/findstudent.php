...
{ 
    $sql= "select students.*,DATE_FORMAT(students.dob,'%d-%m-%Y')AS dob from students where course_name='$course' and cur_semester=$cur_sem and cur_division='$div' and students.spid NOT IN(select spid from ams_setup_students_map where ams_setup_id=$classroomid);";

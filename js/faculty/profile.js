...
$(document).ready(function () {
  $("#edit_icon").click(function () {
    ...
    $("#email_edit").on('input',function () {
      let updatebtn = '<button type="button" id="updateemail" style="padding-bottom:5px;margin:10px;margin-top:-30px;height:30px;" class="btn btn-dark float-right edit_btn">Update</button>';
      let cancelbtn = `<button type="button" onclick={window.location.reload();} id="cancelbtn" style="padding-bottom:5px;margin:10px;margin-top:-30px;height:30px;" class="btn btn-dark float-right edit_btn">Cancel</button>`

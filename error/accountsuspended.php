...
<html lang="en">
    <head>
        ...
        <title>IELTS BUDDY | ACCOUNT SUSPENDED</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <div  style='font-size:0.9em;' class="ml-4 text-lg text-gray-500 uppercase tracking-wider">
                        ACCESS FORBIDDEN DUE TO ACCOUNT SUSPENSION.<br>CONTACT JPD AMS ADMIN.                 </div>
                    </div>
                </div>
            </div>
        </div>

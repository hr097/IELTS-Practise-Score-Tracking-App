    ...
    <div class="container-scroller" style="background-color: #F5F7FF;">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center">
                ...
                <a class="navbar-brand brand-logo mr-3" href="./dashboard.php"><img src="../assets/logos/login-logo.png"
                        alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="./dashboard.php"><img src="../assets/logos/login-logo.png"
        ...
        <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./addscore.php" aria-expanded="false" aria-controls="ui-basic">
                            <i class="icon-head menu-icon ti-eraser"></i>
                            <span class="menu-title">Add Score</span>
                        </a>
                    </li>

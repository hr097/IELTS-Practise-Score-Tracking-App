...
$error = "";
$button = "<button type='submit' id='addcourse' name='addcourse' class='btn btn-dark mr-2 mt-3'>Add Course</button>";
$course_id = "";
$course_name = "";
$ts = "";
...
if(isset($_GET["opt"])&&$_GET["course_id"]&&$_GET["opt"]=="updt") // for getting information about course
{
    ...
    if(mysqli_num_rows($result)>0)
    {
        ...
        $button = "<button type='submit' id='updatecourse' name='updatecourse' class='btn btn-dark mr-2 mt-3'>Update Course</button>";
    }
    else
    {
